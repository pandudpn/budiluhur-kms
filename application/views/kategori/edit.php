<?= form_open('kategori/edit/'.$id, array('id' => 'formKategori')); ?>
<div class="form-group row">
    <label for="judul" class="col-form-label col-md-3">Judul</label>
    <div class="col-md-9">
        <input type="text" class="form-control" id="judul" name="judul" value="<?= $kategori->title; ?>" placeholder="Judul Kategori" autofocus>
    </div>
</div>
<div class="form-group row">
    <label for="deskripsi" class="col-form-label col-md-3">Deskripsi</label>
    <div class="col-md-9">
        <input type="text" class="form-control" id="deskripsi" name="deskripsi" value="<?= $kategori->description; ?>" placeholder="Penjelesan Kategori">
    </div>
</div>
<?= form_close(); ?>
<div id="respon"></div>
